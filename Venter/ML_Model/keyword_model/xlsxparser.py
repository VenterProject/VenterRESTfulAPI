...
def parse(filepath, domain_present, domain_keyword_dict_keys):
    '''
    This function parses the fed xlsx file and creates .txt files based
    on the corresponding domain names(from the input xlsx file)
    Args(1) - xlsx filepath
    Args(2) - domain_present Boolean flag
    Args(3) - dict_keys() containing domain names from the proposal associated with the uploaded xlsx file
