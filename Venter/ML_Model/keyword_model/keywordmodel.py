...
def categorizer(draft_name, keywords):
    ...
    draft_path = os.path.join(BASE_DIR, 'Venter/ML_Model/keyword_model/data/keyword data/', draft_name)
    ...
    for responseDomain in zip(responseDomains):
        ...
        response_path = os.path.join(BASE_DIR, 'Venter/ML_Model/keyword_model/data/keyword data/', responseDomain)
        print('Response Path: ')
        print(response_path)
        print('Draft Path: ')
        print(draft_path)
        if response_path == draft_path:
            results[domain] = {}
